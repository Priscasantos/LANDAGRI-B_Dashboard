...
def run():
    ...
    with tab_teste:
        ...
        st.info(f"""
        **Total de gráficos implementados:** 12
        
        **Tipos de visualização:**
        - Comparativos: Barras duplas, Radar, Heatmap
        - Categóricos: Pizza (2 tipos), Sunburst, Treemap
        - Relacionais: Dispersão, Bolhas
        - Distribuição: Box Plot
        - Temporais: Timeline de disponibilidade
        - Multidimensionais: Coordenadas Paralelas
