...
try:
    ...
    def plot_initiativas_by_resolution_category(filtered_df):
        ...
        return go.Figure().add_annotation(text="plot_iniciativas_by_resolution_category not available", showarrow=False)
    ...
    with tab_methodology_dist:
        ...
        if not filtered_df.empty:
            try:
                ...
                if methodology_fig:
                    setup_download_form(methodology_fig, 
    ...
    with tab_spatial:
        ...
        if not filtered_df.empty:
            try:
                ...
                # Add download functionality
                if spatial_res_fig:
                    setup_download_form(spatial_res_fig, 
    ...
    with tab_accuracy:
        ...
        if not filtered_df.empty:
            try:
                ...
                # Add download functionality
                if global_acc_fig:
                    setup_download_form(global_acc_fig, 
    ...
    with tab_temporal:
        ...
        if not filtered_df.empty:
            try:
                ...
                # Add download functionality
                if temporal_evo_fig:
                    setup_download_form(temporal_evo_fig, 
        ...
        if not filtered_df.empty:
            try:
                ...
                if class_diversity_fig:
                    setup_download_form(class_diversity_fig, 
    ...
    with tab_resolution_analysis: # Content for the new tab
        ...
        if not plotting_functions_loaded:
            ...
            try:
                ...
                # Add download functionality
                if fig_res_launch:
                    setup_download_form(fig_res_launch, 
            ...
            try:
                ...
                # Add download functionality
                if fig_res_cat:
                    setup_download_form(fig_res_cat, 
            ...
            try:
                ...
                # Add download functionality
                if fig_res_heatmap:
                    setup_download_form(fig_res_heatmap, 
            ...
            if not sensors_meta_data:
                ...
                try:
                    ...
                    # Add download functionality
                    if fig_res_sensor:
                        setup_download_form(fig_res_sensor, 
                ...
                try:
                    ...
                    # Add download functionality
                    if fig_res_slope:
                        setup_download_form(fig_res_slope, 
            ...
            if 'Classes' in filtered_df.columns and 'Type' in filtered_df.columns:
                try:
                    ...
                    if not df_for_chart.empty:
                        ...
                        # Add download functionality
                        if fig_dist_classes:
                            setup_download_form(fig_dist_classes, 
                ...
                if 'Type' not in filtered_df.columns:
                    missing_cols.append('Type') # plot_distribuicao_classes uses 'Type' for color
            ...
            if 'Methodology' in filtered_df.columns:
                try:
                    ...
                    if not method_counts.empty:
                        ...
                        # Add download functionality
                        if fig_dist_meth:
                            setup_download_form(fig_dist_meth, 
            ...
            if 'Methodology' in filtered_df.columns and 'Accuracy (%)' in filtered_df.columns and 'Type' in filtered_df.columns:
                try:
                    ...
                    if not df_for_acc_chart.empty:
                        ...
                        # Add download functionality
                        if fig_acc_meth:
                            setup_download_form(fig_acc_meth, 
        ...
        if not plotting_functions_loaded:
            ...
            try:
                ...
                if fig_normalized_heatmap:
                    setup_download_form(fig_normalized_heatmap, 
